...
namespace MyShop.Web.Migrations
{
    ...
    [Migration("20210526031903_AddOrderEntities")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyShop.Common.Entittes.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MyShop.Web.Data.Entities.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("MyShop.Web.Data.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MyShop.Web.Data.Entities.User")
                        .WithMany()
            ...
            modelBuilder.Entity("MyShop.Common.Entittes.OrderDetail", b =>
                {
                    b.HasOne("MyShop.Web.Data.Entities.Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId");

                    b.HasOne("MyShop.Common.Entittes.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("MyShop.Web.Data.Entities.Order", b =>
                {
                    b.HasOne("MyShop.Web.Data.Entities.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
                });
            ...
            modelBuilder.Entity("MyShop.Web.Data.Entities.User", b =>
                {
                    b.HasOne("MyShop.Common.Entittes.City", "City")
                        .WithMany()
